...
<form action="{{ route('update.customer', $customer->id) }}" method="POST">
    ...
    <div class="flex flex-col">
        ...
        <textarea id="address" name="address" placeholder="Masukkan alamat customer"
            class="p-3 border border-black text-base rounded-md mb-5" required>{{ old('address', $customer->address) }}</textarea>
        ...
        <input type="text" id="motorcycle_type" name="motorcycle_type" placeholder="Masukkan tipe motor"
            value="{{ old('motorcycle_type', $customer->motorcycle_type) }}"
            class="p-3 border border-black text-base rounded-md mb-5" required>
        ...
        <textarea id="description" name="description" placeholder="Masukkan deskripsi (opsional)"
            class="p-3 border border-black text-base rounded-md mb-5">{{ old('description', $customer->description) }}</textarea>
    </div>
